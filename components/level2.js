  ...
  return (
      ...
      <div className=" flex flex-row items-center justify-center fullw mt30">
        <Fade bottom>
          ...
          <img src="/lala.png" alt="magnetic sand" width="50%" height="auto" className="logow "></img>
        ...
        <p className="text-center">Timus bezinin faydalarıyla alakalı araştırmalar</p>
          ...
          <img src="/oxford.png" alt="magnetic sand"  width="50%" height="auto" className="logow "></img>
